...
def MyEllipticCurve_from_c4c6(c4, c6):
    r"""
...
def MyEllipticCurve_from_j(j, minimal_twist=True):
    r"""
...
def MyEllipticCurve_from_cubic(F, P=None, morphism=True):
    r"""
...
def MyEllipticCurves_with_good_reduction_outside_S(S=[], proof=None, verbose=False):
    r"""
